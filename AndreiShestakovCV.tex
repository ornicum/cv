...
\end{tabular*}
  ...
  I have also Telegram, WhatsApp and Viber on Russian mobile phone number.
...
I focus on clean code, robust architecture, and end‑to‑end responsibility.

  \end{minipage}
\end{figure}

I have a Bachelor's degree in Applied Mathematics \& Computer  Science (Statistics) from Novosibirsk State Technical University,  recognized as equivalent to a Master's degree by Czech Technical  University in Prague.
...
I'm developing primarily on Python (versions 2.5.x+ and 3.5+) and a little bit on C/C++ (just I don't know all features of standards since C++17). Also last year I have studied Rust and I have my own project developed on the programming language.


%-----------OBJECTIVE-----------------
\section{Objective}
  \begin{itemize}
    \item Senior Software Engineer (Python, Rust)
  \end{itemize}
  ...
  \begin{figure}[h!]
    \begin{minipage}[h!]{0.49\textwidth}
      \begin{itemize}
        ...
        \item{C/C++}
          \begin{itemize}
	    \item STL (exclude last standards since C++20, I'm not so good in it)
	    \item POSIX
	    \item multithreading
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Engineer}{Oct 2016 - Mar 2018}
      \resumeItemListStart
        \resumeItem{Description}
	...
	\resumeItem{Achievements}{Understanding how many requests could be handled by different types of architecture.}
     ...
     \resumeSubheading
       ...
       {Middle Python Developer}{Dec 2015 - Oct 2016}
       \resumeItemListStart
         \resumeItem{Description}
