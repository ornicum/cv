...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://ornicum.ru/}{\Large Andrei Shestakov}} & Email : \href{mailto:ornicum@gmail.com}{ornicum@gmail.com}\\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
	R\&D center in Minsk has big experience in testing FirmWare for SSD. It has HardWare Simulator team, it has FirmWare Software Quality Engineering team, it has Advanced Algorithms team, it has SSD HardWare Verification team, it has FW team.
	
	I'm working in SQE team and I have a project inside huge project.

	Well, SK Hynix has several SSD projects per year. It can be SATA or NVMe projects also the projects at the same time can be Client or Enterprise. Enterprise SSD has some capacitors that help to save cached data to NAND in 15 microseconds. All these projects have some common protocols for common tests, like NVMe protocol tests or may be SATA protocol tests. Also they have some common tests for general working of NAND, for example. But in the same time all these SSD have a set of Vendor Specific Commands, that used by special Vendor Specific Tools.

	So, my main task is not writing tests for Vendor Specific Command only, but also creating arcitecture and infrastructure for making all Vender Specific Command tests common, if it's possible.
